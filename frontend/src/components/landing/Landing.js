      ...
      <div>
        <div className="center">
          ...
          <a href="#about">
            <button
              type="button"
              className="button is-success is-light is-large"
            >
              Learn More!
            </button>
          </a>
        ...
        <div className="row">
          ...
          <div>
            <p className="aboutparagraph">
              {" "}
              <span className="tab" /> Trivia is a memory game where
              participants are asked questions about various topic, and
              participants must answer as many of
              <br />
              correctly. The game provides multiple subjects for the players to
              choose from and has a various levels of difficulty depending on
              <br /> how challenging players want the questions to be. Futher,
              this game can allow players to view the leaderboard of all our
              users.
              <br />
              ...
              <br />
              a good argument among participants and the advantage of developing
              and growing your knowledge, whether in
              <br />
              general or in more particular areas. Trivia players can view their
              scores on the leader board and compete for 1st place
              <br />
